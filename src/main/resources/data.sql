...
INSERT INTO ELEMENT_MAPPING(feeder,elements,role_Name,enable,as_Fields) VALUES('AUTH','IME_TRACE_ID','BILL_OPS','Y','imeTraceId');
INSERT INTO ELEMENT_MAPPING(feeder,elements,role_Name,enable,as_Fields) VALUES('AUTH','MTI_FUNC_CD_1','BILL_OPS','N','mtiFunction');
INSERT INTO ELEMENT_MAPPING(feeder,elements,role_Name,enable,as_Fields) VALUES('AUTH','MTI_FUNC_CD_2','BILL_OPS','Y','mtiFunction');
INSERT INTO ELEMENT_MAPPING(feeder,elements,role_Name,enable,as_Fields) VALUES('AUTH','MTI_FUNC_CD_3','BILL_biz','Y','mtiFunction');
